        ...
        <div class = "box-container">
            <div class="box">
                ...
                <div class = "content">
                    ...
                    <p> Who develop Python language? Basic Syntax of Python language. 
                    </p>
                    <a href ="Images/p1.mp4" class = "btn" > Read More </a>
                    <div class = "icons">
            ...
            <div class="box">
                ...
                <div class = "content">
                    ...
                    <a href ="Images/p2.mp4" class = "btn" > Read More </a>
                    <div class = "icons">
                        <span ><i class = "fas fa-calendar"></i> 4th November, 2022</span>
                        <span ><i class = "fas fa-user"></i>By Admin </span>
                    </div>
            ...
            <div class="box">
                ...
                <div class = "content">
                    ...
                    <a href ="Images/p3.mp4" class = "btn" > Read More </a>
                    <div class = "icons">
                        <span ><i class = "fas fa-calendar"></i> 4th November, 2022</span>
                        <span ><i class = "fas fa-user"></i>By Admin </span>
                    </div>
            ...
            <div class="box">
                ...
                <div class = "content">
                    ...
                    <a href ="Images/p4.mp4" class = "btn" > Read More </a>
                    <div class = "icons">
                        <span ><i class = "fas fa-calendar"></i> 4th November, 2022</span>
                        <span ><i class = "fas fa-user"></i>By Admin </span>
                    </div>
            ...
            <div class="box">
                ...
                <div class = "content">
                    <h3>Casting in Python </h3>
                    <p> process to convert one data type to another.primitive data Type.
                    </p>
                    <a href ="Images/p5.mp4" class = "btn" > Read More </a>
                    <div class = "icons">
                        <span ><i class = "fas fa-calendar"></i> 4th November, 2022</span>
                        <span ><i class = "fas fa-user"></i>By Admin </span>
                    </div>
            ...
            <div class="box">
                ...
                <div class = "content">
                    ...
                    <a href ="Images/p6.mp4" class = "btn" > Read More </a>
                    <div class = "icons">
                        <span ><i class = "fas fa-calendar"></i> 4th November, 2022</span>
                        <span ><i class = "fas fa-user"></i>By Admin </span>
                    </div>
            ...
            <div class="box">
                ...
                <div class = "content">
                    ...
                    <p> List is used to store multiple values. It can be homogeneous and heterogeneous
                    </p>
                    <a href ="Images/p7.mp4" class = "btn" > Read More </a>
                    <div class = "icons">
                        <span ><i class = "fas fa-calendar"></i> 4th November, 2022</span>
                        <span ><i class = "fas fa-user"></i>By Admin </span>
                    </div>
            ...
            <div class="box">
                ...
                <div class = "content">
                    ...
                    <p>Dictionary comes under mapping. It has a key and value pair, known as Item.
                    </p>
                    <a href ="Images/p8.mp4" class = "btn" > Read More </a>
                    <div class = "icons">
                        <span ><i class = "fas fa-calendar"></i> 4th November, 2022</span>
                        <span ><i class = "fas fa-user"></i>By Admin </span>
                    </div>
            ...
            <div class="box">
                ...
                <div class = "content">
                    ...
                    <p>Sets are another data type that does not store duplicate values.
                    </p>
                    <a href ="Images/p8.mp4" class = "btn" > Read More </a>
                    <div class = "icons">
                        <span ><i class = "fas fa-calendar"></i> 4th November, 2022</span>
