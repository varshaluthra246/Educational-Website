...
<script>
    ...
    // create questions
     var questions = [
        new Question("What is the correct syntax to output Hello world in Python?", ["printf(\"Hello World\");", "System.out.println(\"Hello World\");","Console.WriteLine(\"Hello World\");", "print(\"Hello World\");"], "print(\"Hello World\");"),
        ...
        new Question("What is the correct file extension for Python files?", [".py", ".pyt",".pt", ".pyth"], ".py"),
