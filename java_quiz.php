...
<script>
    ...
    // create questions
  var questions = [
        new Question("What is the correct syntax to output Hello world in Java?", ["printf(\"Hello World\");", "System.out.println(\"Hello World\");","Console.WriteLine(\"Hello World\");", "print(\"Hello World\");"], "System.out.println(\"Hello World\");"),
    
        new Question("How do you insert comments in Java code?", ["-- This is a comment", " /* this is a comment","#this is a comment","//this is a comment"], "//this is a comment"),
        
    
        new Question("Which operator can be used to compare two values?", ["<>", "><","==", "="], "=="),
        
    
        new Question("To declare an array in Java, define the variable type with: ", ["()", "{}","[]", "all of the above"], "[]"),
