...
<script>
    ...
    // create questions
    var questions = [
        new Question("What is the correct syntax to output Hello world in C?", ["printf(\"Hello World\");", "System.out.println(\"Hello World\");","Console.WriteLine(\"Hello World\");", "print(\"Hello World\");"], "printf(\"Hello World\");"),
        ...
        new Question("How can you create a variable with the numeric value 5?", ["val num = 5;", "num = 5; ","num = 5 int;", "int num = 5;"], "int num = 5;"),
        
    
        new Question("How can you create a variable with the floating value 2.8?", ["float num = 2.8;", "val num =2.8;","num = 2.8 double;", "num = 2.8 float;"], "float num = 2.8;"),
